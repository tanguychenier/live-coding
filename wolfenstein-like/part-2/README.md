...
> **Part 2 of 4**, written during one live session. [All the parts](../) of this game.
...
Written from an empty file during a single live session, 800 lines in 1 h 42:
**https://youtu.be/SeKs2vCeFUk**
