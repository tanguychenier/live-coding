...
// the signal wave lights the rings this far behind its front, in rail
// units, and this bright at the front
#define SIGNAL_TAIL     0.6
#define SIGNAL_GAIN     1.4

void tunnel_draw(const struct camera *cam, const struct rail *rail, double t_eye,
		 double now, const struct palette *pal);
// a wave of white light runs down the rings from the eye, its front at this
// t. it is the signal leaving at the launch. below zero there is none
